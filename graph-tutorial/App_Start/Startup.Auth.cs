    ...
    public partial class Startup
    {
        ...
        private async Task OnAuthorizationCodeReceivedAsync(AuthorizationCodeReceivedNotification notification)
        {
            ...
            try
            {
                ...
                string userAcc = notification.AuthenticationTicket.Identity.Name; // 從驗證Ticket中取得使用者帳號
                ...
                {
                    string returnUrl = "https://localhost:44328/Login.aspx?returnUrl=https://localhost:44328/Frontpage.aspx";
